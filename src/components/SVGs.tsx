const Tick = () => (
  <svg class="tick" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48">
...
const Cross = () => (
  <svg class="cross" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48">
